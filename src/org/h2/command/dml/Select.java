...
public class Select extends Query {
    ...
    private double preparePlan(boolean parse) {
        ...
        // LILI MADE
        /*Column[] cols = topTableFilter.getColumns();
        System.out.println("cols size: " + cols.length);
        
        Table t = topTableFilter.getTable();
                
        while(topTableFilter.next()) {
        	Row r = topTableFilter.get();
        	System.out.println("row 1: "+r.getValue(1));
        }*/
